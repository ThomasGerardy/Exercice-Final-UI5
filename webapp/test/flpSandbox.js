		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees and Cars",
									"targetURL": "#carempcaremp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"carempcaremp-display": {
								"semanticObject": "carempcaremp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=caremp.caremp",
									"url": sap.ui.require.toUrl("caremp/caremp")
								}
							}
						}
					}
